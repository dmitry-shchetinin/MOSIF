function [model, sol] = model_MIQCQP_infeasible()
%% define model of a simple infeasible MIQCQP problem
...
model.quadcon(1).qc = sparse(2,1,-1,4,1);
model.quadcon(1).rhs = -0.16;
